...
GRANT ALL PRIVILEGES ON SCHEMA geral TO postgres;

-- Conceder permissões totais em todas as tabelas, sequências e funções no esquema 'geral'
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA geral TO postgres;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA geral TO postgres;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA geral TO postgres;
